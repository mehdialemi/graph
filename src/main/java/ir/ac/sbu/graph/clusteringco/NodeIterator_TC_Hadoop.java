...
/**
 * C// M/R code to count the # of triangles in a ir.ac.sbu.graph.
 */
public class NodeIterator_TC_Hadoop extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception
    {
        ...
        job1.setJarByClass(NodeIterator_TC_Hadoop.class);
        ...
        job2.setJarByClass(NodeIterator_TC_Hadoop.class);
        ...
        job3.setJarByClass(NodeIterator_TC_Hadoop.class);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new NodeIterator_TC_Hadoop(), args);
        System.exit(res);
    }
}
