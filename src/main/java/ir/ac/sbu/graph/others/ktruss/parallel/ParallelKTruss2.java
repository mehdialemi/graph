...
public class ParallelKTruss2 extends ParallelKTrussBase {
    ...
    public void start() throws Exception {
        ...
        while (true) {
            ...
            // find edges that should be updated. Here we getOrCreateLFonl a map from edge to vertices which should be removed
    ...
    public static Map<Long, Set<Integer>> findEdgeVerticesMap(final Edge[] edges, final int threads, ForkJoinPool forkJoinPool,
        ...
        // getOrCreateLFonl an arrayList to hold each vertex's degree. index of this arrayList corresponds to vertex Id
