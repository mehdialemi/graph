...
public class AnalyzeAppResults {
    ...
    public void start() {
        ...
        try {
            ...
            if (!successful) {
                System.err.println("unable to getOrCreateLFonl directory " + dir);
                return;
            }
            ...
            while (!stop) {
                ...
                if (logTSet) {
                    ...
                    long tsetTime = sMap.get(JOB_DURATION) - sumTwo;
                    System.out.println("sumTwo: " + sumTwo);
                    System.out.println("jobDuration: " + sMap.get(JOB_DURATION));
