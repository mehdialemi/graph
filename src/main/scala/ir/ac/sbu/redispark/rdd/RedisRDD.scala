package ir.ac.sbu.redispark.rdd

import java.util

import ir.ac.sbu.redispark.partitioner.RedisPartition
import ir.ac.sbu.redispark.{RedisConfig, RedisNode}
...
trait Keys {
    ...
    class RedisKeyValueRDD(sc: SparkContext, override val redisConfig: RedisConfig)
      extends RedisKeysRDD(sc, redisConfig) {
