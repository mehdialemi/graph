...
public class KTrussSparkTriangleVerticesPartitioning extends KTruss {

    public KTrussSparkTriangleVerticesPartitioning(KTrussConf conf) {
        super(conf);
    }
    ...
    public JavaPairRDD<Tuple2<Integer, Integer>, IntSet> start(JavaPairRDD<Integer, Integer> edges) {
        ...
        while (!stop) {
            ...
            log(msg, t2 - t1);
            tvSets = compute(tvSets, minSup, invalids);
    ...
    private JavaPairRDD<Tuple2<Integer, Integer>, IntSet> compute(JavaPairRDD<Tuple2<Integer, Integer>, IntSet> tvSets, int minSup, JavaPairRDD<Tuple2<Integer, Integer>, IntSet> invalids) {
        ...
        JavaPairRDD<Tuple2<Integer, Integer>, Iterable<Integer>> invUpdates = invalids
                .flatMapToPair(kv -> {
    ...
    public static void main(String[] args) {
        KTrussConf conf = new KTrussConf(args, KTrussSparkTriangleVerticesPartitioning.class.getSimpleName(),
                GraphUtils.VertexDegree.class, long[].class, List.class, IntSet.class, IntOpenHashSet.class);

        KTrussSparkTriangleVerticesPartitioning kTruss = new KTrussSparkTriangleVerticesPartitioning(conf);
