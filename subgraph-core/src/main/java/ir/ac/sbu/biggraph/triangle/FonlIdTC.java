package ir.ac.sbu.biggraph.triangle;

import ir.ac.sbu.biggraph.clusteringco.FonlIdGCC;
...
/**
 * Counts total number of triangles in the given ir.ac.sbu.graph using degree based fonl. Copied from {@link FonlIdGCC}.
 */
